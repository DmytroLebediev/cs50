...
int main()
{
    ...
    float fraction = 0.0;
    printf("float value:\t\t\t%e\tof size:\t%lu B\n", fraction, sizeof(float));
    
    small_number = fraction; // short <- float
    
    double big_fraction = 0.0;
    printf("double value:\t\t\t%e\tof size:\t%lu B\n", 
        big_fraction,
        sizeof(double)); //%g, %f, %e
    
    long double very_big_fraction = 0.0;
    printf("long double value:\t\t%Le\tof size:\t%lu B\n",
        very_big_fraction,
        sizeof(long double));
    ...
    printf("char value:\t\t\t%hhi\t\tof size:\t%lu B\n",
        character,
        sizeof(char)); //%hhi
    printf("unsigned char value:\t\t%hhi\t\tof size:\t%lu B\n",
        byte,
